...
func TestCelsiusToFahrenheit(t *testing.T) {
	...
	tests := []test{
		{input: 56.67, want: 134.01}, //Det korrekte svaret er at 56.67°C= 134.0060°F. Slik at jeg runder opp til 134.01
	}
...
func TestKelvinToFarhenheit(t *testing.T) {
	...
	tests := []test{
		{input: 329.82, want: 134.01}, //Det korrekte svaret er at 329.82K= 134.0060°F. Slik at jeg runder opp til 134.01
	}
...
func TestKelvinToCelsius(t *testing.T) { //Celsius = Kelvin - 273.15
	type test struct {
		input float64
		want  float64
	}
...
func TestCelsiusToKelvin(t *testing.T) { //Kelvin = Celsius + 273.15
	type test struct {
		input float64
		want  float64
	}
